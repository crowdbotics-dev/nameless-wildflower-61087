...
## Project Structure
    ...
    ├── nameless_wildflower_61087  # Django project configurations
...
1. Clone this repo and `cd nameless_wildflower_61087`
...
2. Clone this repo and `cd nameless_wildflower_61087`
